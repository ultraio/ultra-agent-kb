...
`quay.io/ultra.io/3rdparty-devtools:0.4.2-ubuntu24` (re-validated 2026-09-26 with a new guestbook
contract + specs; `0.4.1` on 2026-09-25 with an escrow contract + specs + Vue dapp; earlier runs used the July-2026 build) + public npm — every host tool and every other
