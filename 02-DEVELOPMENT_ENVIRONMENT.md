...
| **ultratest2** | `@ultraos/ultratest2` 1.0.3, global | `~/.nvm/versions/node/v22.21.0/bin/ultratest2` → symlink to `ultratest2` | contract test framework (TS, runs via `tsx`, no build step) |
