...
Living exemplars: `eosio.contracts-defi/ultratests/` (52+ specs).
...
```bash
# one spec
ultratest2 --contracts-dir-path=eosio.contracts-defi/build/contracts \
  -t eosio.contracts-defi/ultratests/ultra.dex/swap_v0.spec.ts
